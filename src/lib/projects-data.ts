...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subtitle: "Creative ops · superscale workflows",
    year: "2024 – Now",
    role: "AI-assisted Direction · Production",
    image: caseCarpeDiem,
    description:
      "AI is my second pair of hands. I use it across the whole creative pipeline — from research and trend spotting to scripting, editing, repurposing and scaling output without losing the brand voice.",
    bullets: [
      "Trend & keyword research with LLMs — read the market in real time and brief faster.",
      "Concepting and scripting with ChatGPT, Claude and Gemini — multiple angles in minutes.",
      "AI image and video generation (Midjourney, Runway, Sora, Kling) for moodboards, b-roll and concept tests.",
      "Editing workflows with CapCut AI, Descript and Eleven Labs for voiceovers and dubs.",
      "Repurposing one shoot into 20+ formats across TikTok, Reels, Shorts and static.",
      "Custom GPTs and prompt libraries to keep brand voice consistent across freelancers.",
    ],
    stats: [
      ["10x", "Output per shoot"],
      ["6+", "AI tools in stack"],
