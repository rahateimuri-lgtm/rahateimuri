...
export const projects: Project[] = [
  ...
  },
  {
    id: "ai",
    title: "How I Use AI",
    shortTitle: "How I Use AI",
    subtitle: "Portfolio Studio · honest workflow note",
    year: "2024 – Now",
    role: "AI-assisted drafting · human final edit",
    image: caseCarpeDiem,
    description:
      "A warm, honest note on how AI shows up in my work — what it helps with, what stays mine, and the boundaries I keep so the output still feels human.",
    body: [
      "What AI does for me — AI is the fast first draft. I lean on it to outline structure, unblock a blank page, rephrase a clunky sentence, and move from idea to something I can react to in minutes instead of hours. It is speed and scaffolding, not the finished thing.",
      "What stays human — Strategy, taste and the final edit are mine. Which angle to take, what to cut, when a line feels off, what to never say — those are judgement calls. Every word that goes live is read, rewritten and approved by me.",
      "Safety boundary — No real client names, no confidential details, and no copied text from internal docs ever go into a prompt. Sensitive specifics are swapped for placeholders before anything leaves my machine, and nothing AI returns is published without a human pass.",
      "How it shows up on this site — A copy-email button instead of exposing the address, full support for prefers-reduced-motion so animations calm down on request, and a clean-room rebuild approach: every page was rebuilt from scratch with placeholder content, no client assets reused.",
    ],
    bullets: [
      "First drafts and structure — never final copy.",
      "Placeholders in, never real names or client data.",
      "Every output gets a human edit before it ships.",
      "Accessibility-first: reduced motion, semantic markup, copy-email pattern.",
    ],
    stats: [
      ["~3x", "Faster first drafts"],
      ["100%", "Human-edited before publish"],
      ["0", "Real client details in prompts"],
    ],
    links: [
  ...
  },
  {
    ...
    subtitle: "Turning reach into revenue",
    year: "2020 – Now",
    role: "Strategy · Partnerships · Conversion",
    image: caseCarpeDiem,
    description:
      "Audience is only valuable when it converts. I design the full funnel — from hook to booking — so social reach turns into measurable revenue, partnerships and brand deals.",
    bullets: [
      "Built funnels turning short-form views into €40K+ in direct bookings for Carpe Diem Tours.",
      "Affiliate, UGC and creator-partnership deals — negotiated, briefed and tracked.",
      "Sponsored content & brand integrations placed without breaking organic trust.",
      "Product placement inside high-performing formats (the 2.5M-view TikTok converted at >€17K).",
      "Cross-platform monetization: TikTok Creator, Meta in-stream, YouTube ads, brand deals.",
      "Pricing, rate cards and ROI reporting for partners and internal stakeholders.",
    ],
    stats: [
      ["€40K+", "Direct bookings driven"],
      ["50M+", "Reach monetized"],
